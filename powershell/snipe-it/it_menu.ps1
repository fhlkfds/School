...
function Asset-Management-Menu
{
    ...
    switch ($menuInput)
    {
        ...
        "4"
        { 
            Write-Host "Update Asset Information functionality will be implemented here" -ForegroundColor Yellow
            Start-Sleep -Seconds 2
            Asset-Management-Menu
        }
        "5"
...
function Reporting-Menu
{
    ...
    switch ($menuInput)
    {
        ...
        "3"
        { 
            Write-Host "Depreciation Report functionality will be implemented here" -ForegroundColor Yellow
            Start-Sleep -Seconds 2
            Reporting-Menu
        }
        "4"
        ...
        "5"
        { 
            Write-Host "Custom Report Builder functionality will be implemented here" -ForegroundColor Yellow
            Start-Sleep -Seconds 2
            Reporting-Menu
        }
        "B"
