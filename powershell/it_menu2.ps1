...
# Function to call the Templates script
function Call-TemplatesScript
{
    $scriptPath = Join-Path -Path $PSScriptRoot -ChildPath "SnipeIT_Templates.ps1"
    ...
    {
        Write-Host "Templates script not found at: $scriptPath" -ForegroundColor Red
        Write-Host "Please ensure the SnipeIT_Templates.ps1 file is in the same directory as this script." -ForegroundColor Yellow
        Start-Sleep -Seconds 3
    }
}
...
function Templates-Menu
{
    ...
    switch ($menuInput)
    {
        "1"
        { 
            Write-Host "Generate Asset Import Template functionality will be implemented here" -ForegroundColor Yellow
            Start-Sleep -Seconds 2
            Templates-Menu
        }
        "2"
        { 
            Write-Host "Generate User Import Template functionality will be implemented here" -ForegroundColor Yellow
            Start-Sleep -Seconds 2
            Templates-Menu
        }
        "3"
        { 
            Write-Host "Generate License Import Template functionality will be implemented here" -ForegroundColor Yellow
            Start-Sleep -Seconds 2
            Templates-Menu
        }
        "4"
        { 
            Write-Host "Generate Maintenance Import Template functionality will be implemented here" -ForegroundColor Yellow
            Start-Sleep -Seconds 2
            Templates-Menu
        }
        "5"
        { 
            Write-Host "View Template Documentation functionality will be implemented here" -ForegroundColor Yellow
            Start-Sleep -Seconds 2
            Templates-Menu
        }
        "B"
